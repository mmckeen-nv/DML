...
This version includes Citizen Snips DML default retrieval, DPM overlay rendering, DCN active-read gates, and memory hygiene hardening for bounded context use.
...
- Restart the Hermes CLI/gateway after updating plugin code so the provider module is reloaded.
