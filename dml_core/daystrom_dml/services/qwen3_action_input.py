...
from .qwen3_model_input import LocalQwen3InputConsumer
...
class LocalQwen3ActionInputConsumer(LocalQwen3InputConsumer):
    ...
    def compile(self, messages, tools=None, *, output_reserved_tokens):
        ...
        if not request.messages or request.messages[0] != expected:
            raise ModelInputError("Qwen3 recovery profile requires its exact first system message")
