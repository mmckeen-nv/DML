...
from cma.adapter import CMAAdapter
...
def main(argv: Optional[list[str]] = None) -> None:
    """Entry point used by the ``cma-mcp-server`` console script."""

    parser = argparse.ArgumentParser(description="Run the CMA MCP server.")
    parser.add_argument(
        "--name",
