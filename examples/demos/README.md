...
The service can be built with `examples/Dockerfile` or launched directly:

```bash
python -m examples.demos.dml_service
```
...
- **NIM/OpenAI-style LLM**: `python -m examples.demos.nim_demo`
- **ACE-like agent with instance memory**: `python -m examples.demos.ace_agent_demo`
- **Isaac robotics logging**: `python -m examples.demos.isaac_demo`
